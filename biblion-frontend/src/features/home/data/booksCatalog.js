...
import dragoesCacadores from '../../../assets/images/covers/dragoes-de-eter-cacadores-de-bruxas.jpg';
import dragoesCirculo from '../../../assets/images/covers/dragoes-de-eter-circulo-de-chuva.jpg';
import dragoesCoracoes from '../../../assets/images/covers/dragoes-de-eter-coracoes-de-neve.jpg';
import dragoesEstandartes from '../../../assets/images/covers/dragoes-de-eter-estandartes-de-nevoa.jpg';
...
export const booksCatalog = [
    ...
    { id: 11, title: "Dragões de Éter: Caçadores de Bruxas", author: "Raphael Draccon", cover: dragoesCacadores, description: "Em um mundo onde a magia convive com a indústria, um grupo de caçadores enfrenta bruxas que manipulam dragões. Aventuras, traições e pactos antigos definem o destino dos protagonistas." },
    { id: 12, title: "Dragões de Éter: Círculo de Chuva", author: "Raphael Draccon", cover: dragoesCirculo, description: "A sequência aprofunda a trama política entre reinos e o misterioso Círculo de Chuva, uma ordem que guarda segredos capazes de despertar dragões adormecidos." },
    { id: 13, title: "Dragões de Éter: Corações de Neve", author: "Raphael Draccon", cover: dragoesCoracoes, description: "Quando um inverno mágico cobre o continente, alianças improváveis se formam para salvar cidades inteiras — e dragões com corações de gelo revelam seu verdadeiro papel." },
    { id: 14, title: "Dragões de Éter: Estandartes de Névoa", author: "Raphael Draccon", cover: dragoesEstandartes, description: "Conspirações antigas vêm à tona enquanto estandartes surgem cobertos por névoa; heróis e vilões lutam pelo controle dos céus e pela liberdade dos dragões." },
    ...
    { id: 25, title: "O Senhor dos Anéis: A Sociedade do Anel", author: "J.R.R. Tolkien", cover: "https://via.placeholder.com/150x200/2C3E50/FFFFFF?text=LOTR1" },
    { id: 26, title: "O Hobbit", author: "J.R.R. Tolkien", cover: "https://via.placeholder.com/150x200/2C3E50/FFFFFF?text=HOBBIT" },
    { id: 27, title: "Percy Jackson e o Ladrão de Raios", author: "Rick Riordan", cover: "https://via.placeholder.com/150x200/2C3E50/FFFFFF?text=PJ1" },
    { id: 28, title: "Percy Jackson e o Mar de Monstros", author: "Rick Riordan", cover: "https://via.placeholder.com/150x200/2C3E50/FFFFFF?text=PJ2" }
];
